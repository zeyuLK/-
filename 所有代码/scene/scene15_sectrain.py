...
def second_train():
    ...
    pretrained_model_path = 'D:/Study/RMPF/model_inf/scene15_pretrained_model.pth'
    try:
    ...
    # 保存第二次训练后的模型
    second_trained_model_path = 'D:/Study/RMPF/model_inf/scene15_second_trained_model.pth'
